...
- The price-list card and shared Order/Invoice picker display `imageUrl` with an icon fallback.
- The shared picker groups item types by category and opens variants/prices in the existing `DetailOverlay`; tested on the local order page.
