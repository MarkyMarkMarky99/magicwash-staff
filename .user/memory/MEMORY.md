...
- **`fix/tsc-order-quantity`** - TSC tag defaults and button enablement now use the Order header quantity; awaiting review, commit, and production merge. Details: .user/memory/fix-tsc-order-quantity.md.
