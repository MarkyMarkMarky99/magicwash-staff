...
// The real component now lives at '@/features/gallery/components/CameraOverlayPage.vue'.
...
export { default } from '@/features/gallery/components/CameraOverlayPage.vue'
</script>
