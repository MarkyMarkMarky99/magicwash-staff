...
<template>
  ...
  >
    <RouterView v-slot="{ Component }">
      ...
      <KeepAlive
        :exclude="['CreateAppointmentPage', 'RescheduleAppointmentPage', 'InvoiceCreatePage', 'CustomerPackageCreatePage', 'PriceListFormPage', 'PackageFormPage', 'IssueReportFormPage']"
      >
