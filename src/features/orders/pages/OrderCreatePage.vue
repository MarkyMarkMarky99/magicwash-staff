...
const invalid = computed(() => isEdit
  ? !loadedOrder.value || !form.receivedDate || !form.dueDate || datesOutOfOrder.value || quantityInvalid.value || Object.keys(updatePayload.value).length === 0
