...
This file is build history. There is no canonical cache convention yet; the unfinished draft
sits at `agent-docs/conventions/data-fetching.md` and is not a rule.
